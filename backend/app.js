...
function isLoggedIn(req, res, next) {
  if (!req.session.user) {
    // for API we return JSON; for web fallback redirect
...
app.get("/categories", isLoggedIn, categoryController.getCategories);
app.post("/categories", isLoggedIn, categoryController.createCategory);
